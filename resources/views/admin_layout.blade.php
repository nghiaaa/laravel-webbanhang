            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <img alt="" src="{{asset('public/backend/images/nghiaf.png')}}">
                        <span class="username">Nghĩa ^^</span>
                        <b class="caret"></b>
                    </a>
        ...
        <!-- footer -->
            <div class="footer">
                <div class="wthree-copyright">
                    <p>Trường đại học điện lực | Design by <a> Nghia-D14HTTMDT1 </a></p>
                </div>
            </div>
            <!-- / footer -->
        </section>
...
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="{{asset('public/backend/js/excanvas.min.js')}}"></script><![endif]-->
