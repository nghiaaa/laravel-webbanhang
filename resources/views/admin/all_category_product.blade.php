                ...
                <table class="table table-striped b-t b-light">
                    ...
                    @foreach($all_category_product as $key => $cate_pro)
                        <tr>
                            ...
                            <td>
                                <a href="{{URL::to('/admin/edit-category-product',$cate_pro->category_id)}}" class="active" ui-toggle-class="">
                                    <i class="fa fa-pencil-square-o text-success text-active">sửa</i></a>
                                <a onclick= "return confirm('Bạn có chắc là muốn xóa danh mục này?')" href="{{URL::to('/admin/delete-category-product',$cate_pro->category_id)}}" class="active" ui-toggle-class="">
